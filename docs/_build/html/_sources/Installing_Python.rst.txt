...
The easiest path to this is to install Python via `Anaconda`_. Note that the default is Python 2.7. **You must install** Python 3.5 or later for the Vibration Toolbox to work.
